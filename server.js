...
app.post('/api-login/login', function (req, res) {
    ...
    if (login(user, pass)) { // Correct user-pass
        ...
        loggedUser = user;
        console.log("Session contents from login call:", req.session);
        res.status(200).send();
...
app.post('/api-sessions/get-token', function (req, res) {
    // HACKKED FOR MAKING IT WORK::
    // req.session.loggedUser = "publisher1"; For some reason logged user is not added to req.session even when added in log in api request.
    console.log("Session conents from get token  call:", req.session);
